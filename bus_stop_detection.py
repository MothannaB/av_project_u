...
# # Get the blueprint library and filter for the vehicle blueprints
#         vehicle_blueprints = world.get_blueprint_library().filter('*walker*')    
...
#         for i in range(0,1):
#             sp_loc = random.choice(spawn_points)
#             print(type(sp_loc))

#             sp_loc = carla.Transform(carla.Location(x=-201.536270, y=161.750095, z=0.5))
...
def main(args=None):
    ...
    node = BusStopDetection() # Create an instance of the YoloDetectionNode
